...
def generate_playlist_stream(
    ...
    try:
        ...
        if use_qobuz and qobuz_target > 0:
            ...
            try:
                qobuz_tracks = _discover_qobuz_tracks(
...
def _discover_qobuz_tracks(
    ...
    Returns:
        List of Track objects with source="qobuz"
    """
    ...
    try:
        response = llm_client.generate(suggestion_prompt, QOBUZ_SUGGESTION_SYSTEM)
        suggestions = llm_client.parse_json_response(response)
    except Exception as e:
