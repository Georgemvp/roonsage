...
class TestTransportControlExtended:
    ...
    def test_shuffle_toggle(self, client):
        roon = _mock_roon()
        roon.transport_control.return_value = RoonResponse(
            success=True,
            zone_name="Woonkamer",
            action="shuffle",
            state="on",
...
class TestVolumeControl:
    ...
    def test_set_volume(self, client):
        roon = _mock_roon()
        roon.volume_control.return_value = RoonResponse(
...
class TestZoneTransfer:
    ...
    def test_transfer_zone(self, client):
        roon = _mock_roon()
        roon.transfer_zone.return_value = RoonResponse(
...
class TestZoneGrouping:
    ...
    def test_list_groups(self, client):
        roon = _mock_roon()
        roon.zone_grouping.return_value = RoonResponse(
...
class TestPlayRadio:
    ...
    def test_play_radio_success(self, client):
        roon = _mock_roon()
        roon.play_radio.return_value = RoonResponse(
...
class TestBrowsePlaylists:
    ...
    def test_list_playlists(self, client):
        roon = _mock_roon()
        roon.browse_playlists.return_value = RoonResponse(
