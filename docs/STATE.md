...
## Now
B1-B5 KLAAR (perf serverside+client) + analyzer-v1.1.101 GEDEPLOYD op de mini. Volgende brok: B6 UX (Live Activity contrast, iOS deep-nav, gedeelde ZoneGate, tool-error-states, localisatie), dan B7 architectuur, B8+ 13 features.
