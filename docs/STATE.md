...
## Now
B1-B6a + B7a + B8(skip-re-steer, op-deze-dag, taste-timemachine) KLAAR. Analyzer REDEPLOY loopt (v1.1.108) → alle B4-serverfixes + /on-this-day + /taste-timemachine live.
