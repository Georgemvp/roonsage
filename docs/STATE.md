...
## Now
B1-B6a + B7a + B8(skip-re-steer, op-deze-dag, taste-timemachine) KLAAR. Analyzer-v1.1.108 GEDEPLOYD+GEVERIFIEERD op de mini → alle B4-serverfixes + /on-this-day + /taste-timemachine LIVE. Volgende: meer B8-features óf client-fetch+UI voor de nieuwe endpoints.

## Next
- B8+ Features resterend (kies logica-zware/testbare eerst): loudness-normalisatie, crossfade, NL steering, scenes, share-cards, Siri-intents, Control Center, gapless, CarPlay, chat-agent
