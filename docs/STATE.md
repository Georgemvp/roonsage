...
## Now
B1-B4 KLAAR + analyzer-v1.1.101 GEDEPLOYD op de mini. B5a (Music Map spatial index H7/M9) GESHIPT. Volgende: B5b taste/embedding alloc (M1-4), dan B6 UX, B7 architectuur, B8+ features.

## Next
- B5b Perf client: taste/embedding alloc (M1-4)
