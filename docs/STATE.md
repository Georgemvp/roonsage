...
## Now
B1-B6a + B7a + B8-features + ALLE consumers KLAAR (terugblik-pivots + NL-steer-veld). Elke gebouwde API heeft nu een consumer. Live op mini = analyzer-v1.1.108 (endpoints live). Volgende: meer B8-features.
